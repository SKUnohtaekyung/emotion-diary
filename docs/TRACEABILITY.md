...
| 위기 안내·AI 위기 전환 화면에 친구·감정 색·조약돌·빛·움직임을 쓰지 않음(D-061 ⑤, D-065 ①) | PR-001, PR-007, PR-010 | 위기 안내(`#/help`)와 AI 위기 전환의 화면 대조(UI-MOOD-005). 시안의 `#/help`는 코드상 친구·감정 색·조약돌·빛·움직임이 없다(2026-09-22), AI 위기 전환은 후행 단계 |
