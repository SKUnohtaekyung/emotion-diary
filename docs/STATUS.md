...
4. **taxonomy v2 심리학 리서치(D-038)**: 전공자가 봐도 어색하지 않은 감정 목록을 문헌 근거로 만든다. 원자료의 알려진 문제 — 공포 카테고리 부재, 놀람이 기쁨에만, 즐거움·기쁨 경계 중첩, 바램의 동기 성격. 비진단 경계(PR-001)·척도 라이선스·한국어 뉘앙스·카테고리 변경 시 색(ΔE·대비)과 `emotion_code` 마이그레이션까지 함께 판단한다. **카테고리 구성 변경은 사용자 승인 사항.**
