...
- 다음(실행·리서치):
  1. ~~**아크 휠 큰 글자 폴백**~~ **[무효, 2026-09-10] D-041로 아크 휠 자체가 폐기됐다.** 별자리 지도의 큰 글자 폴백(3열 격자, 칸 101px)은 `DESIGN_SYSTEM` §6.2에 이미 규정돼 있다. 남은 실제 과제는 **스타일 가이드에 별자리 절을 구현하고 아크 절을 걷어내는 것**이다(위 인계 항목).
